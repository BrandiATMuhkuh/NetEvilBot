...
network-filename
network-filename
false "AdHealthForNetLogo/comm2.txt" "AdHealthForNetLogo/comm3.txt" "AdHealthForNetLogo/comm37.txt" "AdHealthForNetLogo/comm55.txt" "AdHealthForNetLogo/comm63.txt" "AdHealthForNetLogo/comm50.txt"
0
...
<experiments>
  ...
  <experiment name="LC_adhealthcomm50_nearby_hires" repetitions="100" runMetricsEveryStep="false">
    <setup>setup-network-with-instigator-degree desired-instigator-degree</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <exitCondition>converged?</exitCondition>
    ...
    <enumeratedValueSet variable="network-filename">
      <value value="&quot;AdHealthForNetLogo/comm50.txt&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="learning-rate">
      <value value="0.1"/>
    </enumeratedValueSet>
